...
namespace ClinicAPI.Repositories
{
    public class AppointmentRepo : IAppointmentRepo
    {
        ...
        {
            new() { AppointmentId = 1,  DoctorId = 7, PatientId = 1,  Date = d(18,  9), IsDone = false, CreatedAt = now.AddDays(-4), IsDeleted = false },
            new() { AppointmentId = 2,  DoctorId = 2, PatientId = 2,  Date = d(18, 10), IsDone = true,  CreatedAt = now.AddDays(-4), IsDeleted = false },
            new() { AppointmentId = 3,  DoctorId = 3, PatientId = 3,  Date = d(19, 11), IsDone = false, CreatedAt = now.AddDays(-3), IsDeleted = false },
            new() { AppointmentId = 4,  DoctorId = 5, PatientId = 4,  Date = d(19, 12), IsDone = false, CreatedAt = now.AddDays(-3), IsDeleted = false },
            new() { AppointmentId = 5,  DoctorId = 1, PatientId = 5,  Date = d(20,  9), IsDone = false, CreatedAt = now.AddDays(-2), IsDeleted = false },
            new() { AppointmentId = 6,  DoctorId = 8, PatientId = 6,  Date = d(20, 10), IsDone = true,  CreatedAt = now.AddDays(-2), IsDeleted = false },
            new() { AppointmentId = 7,  DoctorId = 4, PatientId = 7,  Date = d(21,  9), IsDone = false, CreatedAt = now.AddDays(-1), IsDeleted = false },
            new() { AppointmentId = 8,  DoctorId = 3, PatientId = 8,  Date = d(21, 10), IsDone = false, CreatedAt = now.AddDays(-1), IsDeleted = false },
            new() { AppointmentId = 9,  DoctorId = 7, PatientId = 9,  Date = d(22, 11), IsDone = false, CreatedAt = now,           IsDeleted = false },
            new() { AppointmentId = 10, DoctorId = 6, PatientId = 10, Date = d(22, 12), IsDone = false, CreatedAt = now,           IsDeleted = false },
        };
