...
- Relationships configured (Patient↔Appointments, Doctor↔Appointments, Patient↔Doctor)
...
> If `includeAppointments=true`, related appointments must be loaded using EF Core `Include(...)` (otherwise nav props stay empty).
