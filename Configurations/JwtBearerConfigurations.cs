...
namespace ClinicAPI.Configurations
{
    ...
    public class JwtBearerConfigurations : IConfigureNamedOptions<JwtBearerOptions>
    {
        private readonly IOptions<JwtSettings> _jwtSettings;
        public JwtBearerConfigurations(IOptions<JwtSettings> jwtSettings)
        {
        ...
        public void Configure(string? name, JwtBearerOptions options)
        {
            ...
            var settings = _jwtSettings.Value; // getting the object (JwtSettings)
